...
<body>
    ...
    <!-- Hero Start -->
    <div style="background: #040303; font-family: Poppins" class="hero">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-12 col-md-6">
                    <div class="hero-text">
                        <h1 style="color: #fff;">We create spectacular digital solutions</h1>
                        <p style="color: #fff">
                           Rabit Jump is a software developement company building modern softwares for small-to medium-sized businesses and startups.
                        </p>
                        <div class="hero-btn">
                            <a href="signup.php" style="background:#fff; color:#000" class="btn" href="">Get Started</a>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-6">
                    ...
                    <div class="about-text">
                        ...
                        <p>
                        Rabit Jump Team is a uniquely talented group of IT professionals with the ability to dive deep for the enduring digital solutions you need. Our strength lies in the cognitive diversity of our team and the productive, long-term relationships we create with
            ...
            <div style="background: #000;" class="container-fluid">
                <div class="container">
                    <div  class="footer-info">
                        <a href="index.html"  style=" color:#fff; font-family:Sui Generis" class="footer-logo">Rabitjump</a>
