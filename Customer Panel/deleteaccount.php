        ...
        <div class="contact">
            <div class="container">
                <div class="section-header text-center wow zoomIn" data-wow-delay="0.1s">
                    <p>Please Continue to delete Account</p>
                    <h2>Confirmation</h2>
                </div>
                <div class="row">
                    <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="contact-form">
                           ...
                           <p style="margin-left:40%">Are you sure to delete account?</p>
                      
                                <div>
                                   <a href="deleteuser.php"> <button name="delete" style="background:#000; color:#fff; margin-left:40%" class="btn" type="submit"> Confirm Delete</button>
