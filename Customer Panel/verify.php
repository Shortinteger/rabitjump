...
$verified= "Verified";
$msg=mysqli_query($conn,"UPDATE tbl_clients SET verification_status = '$verified'  where id='$id'");
                ...
                <div class="row">
                    <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="contact-form">
                                ...
                                <a style="margin-left:30%" href="signin.php"> <strong>Click here for Login</strong></a>
                        </div>
                    </div>
                </div>
            </div>
