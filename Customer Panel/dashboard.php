...
<body>
                ...
                <div  style="font-family:Poppins; " class="navbar-nav ml-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="logout.php" style="color: #000;" class="nav-item nav-link">Logout</a>
                     
                            <a href="deleteaccount.php" style="color: #000;" class="nav-item nav-link">Delete Account</a>
                        </div>
                    </div>
    ...
    <!-- Nav Bar End -->
        ...
        <main class="content">
            ...
            <div class="container">
                ...
                $query = "SELECT * FROM tbl_order_payment where customer_id= '$customer_id'";
  ...
  <tbody>
    ...
    <div class="footer wow fadeIn" data-wow-delay="0.3s">
        ...
        <a href="#"style="background:#000" class="back-to-top"><i  style="background:#000; COLOR: #fff" class="fa fa-chevron-up"></i></a>
