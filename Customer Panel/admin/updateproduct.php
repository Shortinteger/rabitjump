...
<body>
    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        ...
        <div class="main">
            ...
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">Update Product Details</h1>
            ...
            <div class="col-md-8 col-xl-10">
                ...
                <div class="card-header">
                        ...
                        <form method="post" action="editproduct.php?pro_id=<?php echo $row['pro_id']?>" enctype="multipart/form-data">
                   
                        <p > <label style="float: left; padding:5px">Product Name</label></p>  
                        <p style="margin-left: 20%;" > <input type="text" placeholder="Product Name..." value="<?php echo $row['pro_name'];?>" name="pro_name" required></p>  
                        <p > <label style="float: left; padding:5px">Product Type</label></p>                                           
                          <p style="margin-left: 20%;"><input  type="text" placeholder="Product Type"  name="pro_type" value="<?php echo $row['pro_type']?>" required></p>  </p>  
                          <p > <label style="float: left; padding:5px">Product Price </label></p>                                           
                          <p style="margin-left: 20%;"><input type="text" placeholder="Product Price in dollars..."  name="Price" value="<?php echo $row['Price']?>" required> </p>  
                          <p style="float: left; padding:5px"> <label >Upload Image</label></p>  
                          <p style="float: left;margin-left:4%">         <input type="file" placeholder="Upload Image"  name="image1" value="<?php  echo $row['image1']?>" required> </p>   
                          <p style="padding:5px; margin-top:10%"> <label style="float:left" >Upload File</label></p>  
                          <p style="margin-top:-4%; margin-left:19%">    <input type="file" placeholder="Upload file"  name="file" value="<?php echo $row['file'] ?>" required></p> 
                        ...
                        <p style="margin-left: 19%;padding:5px; width: 32%"><select class= "form-control" name="cat_id" id="" style="padding:8px">
                                        ...
                                        <?php
                                          ...
                                          foreach($cat_run as $r)
                                            {      ?> 
                                              <option value="<?php echo $row['cat_id'];?>" ><?php echo $r['cat_name'];?> </option>
                                              <?php 
                                            }	
                                         ?>
                          ...
                          <p style="float:left;"><input type="text" placeholder="Description"  name="description" value="<?php echo $row['description']?>" required> </p>
