...
if(isset($_POST['insert']))
{
...

    {
           ...
           $project_id=rand(111111111,999999999); 
        $query = "INSERT INTO tbl_project
        (project_id,project_name,project_manager_id,project_remarks,hourly_rate,Budget,total_hours,project_sdate,project_edate,status)
         VALUES ('$project_id','$project_name','$project_manager_id','$project_remarks','$hourly_rate','$Budget','$total_hours','$project_sdate','$project_edate','$status')";
            ...
            <div class="col-md-8 col-xl-10">
                ...
                <div class="card-header">
                        ...
                        <div>
                            ...
                            <p style="margin-left: 20%; " > <input style="padding:5px" type="text" placeholder="Project Name..."  name="project_name" required></p>
                        ...
                        <p style="margin-left: 19%;padding:5px; width: 32%"><select name="project_manager_id" style="padding:8px">
                            ...
                            <p style="margin-left: 20%; width: 30%;" ><input style="padding:5px" type="date" placeholder="Project Start Date"  name="project_sdate"></p>
                           
                            <p > <label style="float: left; padding:5px">Project End Date</label></p>  
                            <p style="margin-left: 20%; width: 30%"><input style="padding:5px" type="date"  placeholder="Project End Date"  name="project_edate" ></p> 
                            <p > <label style="float: left; padding:5px">Total Hours</label></p>  
                            <p style="margin-left: 20%;" > <input style="padding:5px" type="text" placeholder="Project hours"  name="total_hours" required></p> 
                            <p > <label style="float: left; padding:5px">Hourly Rate</label></p>  
                            <p style="margin-left: 20%;" > <input style="padding:5px"type="text" placeholder="Project hourly rate"  name="hourly_rate" required></p> 
                            <p > <label style="float: left; padding:5px">Budget</label></p>  
                            <p style="margin-left: 20%;" > <input style="padding:5px" type="text" placeholder="Project Budget"  name="Budget" required></p> 
                            <p > <label style="float: left; padding:5px">Status</label></p> 
                            <p style="margin-left: 20%; width: 30%"> <select style="padding:5px" placeholder="Status" name="status" required>
                                                                <option value="Done">Done</option>
                                                                <option value="Cancelled">Cancelled</option>
                                                                <option value="In progress">In progress</option>
                                                                    </select></p>        
                            <p style="float: left; padding:5px" > <label >Remarks</label></p>  
                            <p style=" float:left;margin-left:11%">   <textarea  placeholder="Remarks " name="project_remarks" rows="2" cols="23"></textarea></p>
