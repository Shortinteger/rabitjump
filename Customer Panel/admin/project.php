    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        ...
        <div class="main">
            ...
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3">Projects List</h1>
                    <div class="mb-3">
					
                        <a href="addproject.php" ><button  style="margin-left:80%" class="btn btn-primary">   <i class="align-middle" data-feather="user-plus"></i> <span>Add Project</span></button></a>
					</div>
  ...
  <tbody>
                        ...
                        ?>
                               <tr>
                                ...
                                <td> <a href="viewproject.php?project_id=<?php echo $row['project_id']?>"><button class="btn btn-primary"> <span>Details</span></button></a>
                                </td>
