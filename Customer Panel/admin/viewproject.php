    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        ...
        <div class="main">
            ...
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3">Projects details</h1>
  ...
  <tbody>
                        ...
                        ?>
                               <tr>
                                ...
                                <td><?php  echo $row['project_remarks']; ?></td>
                                <td><?php  echo $row['project_sdate']; ?></td>
                                <td><?php  echo $row['project_edate']; ?></td>
                                <td><?php  echo $row['status']; ?></td>
                                <td><?php  echo $row['hourly_rate']; ?></td>
                                
                                <td> <a href="editproject.php?project_id=<?php echo $row['project_id']?>"><button  class="btn btn-primary"> <span>Edit</span></button></a>
                                    
                                
                                    <a href="deleteproject.php?project_id=<?php echo $row['project_id']?>"> <button type="submit" class="btn btn-secondary"> <span>Del</span></button></a>   
                                </td>
