...
<body>
            ...
            <div class="col-md-8 col-xl-10">
                ...
                <div class="card-header">
                    ...
                    <div >
                            ...
                            <p >    <input type="text" id="skills" placeholder="Employee's Skills" name="skills" data-role="tagsinput" required  />	</p>   
    ...
    <script src="/admin/bootstrap-tagsinput-master/src/bootstrap-tagsinput.js"></script>
     <script> 
     $('#skills').tagsinput({
   confirmKeys: [13, 44],
   maxTags: 10
